...
*/
$page_title = 'Perfil - Profesor';
$page_stylesheet = '../style/perfil_prof.css';
...
<div class="top-bar">
    ...
    <div class="project-info">
        ...
        <span class="module-name">Perfil - Profesor</span>
    </div>
</div>
    ...
    <aside class="menu-container" id="menu-container">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="perfil.php" class="menu-link active"><img src="../multimedia/profesor/perfil-usuario.png" alt=""> Perfil</a></li>
                    ...
                    <form id="profile-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="ciudad_expedicion" name="ciudad_expedicion" class="readonly-field" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
