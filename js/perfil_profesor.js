...
function populateProfileForm(profile) {
    ...
    document.getElementById('tipo_documento').value = profile.tipo_documento || '';
    document.getElementById('no_documento').value = profile.no_documento || '';
    document.getElementById('fecha_nacimiento').value = profile.fecha_nacimiento || '';
