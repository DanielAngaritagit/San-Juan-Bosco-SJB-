...
try {
    // Asumiendo que los bibliotecarios pueden ser identificados por un rol o especialidad.
    ...
    $response = ['success' => true, 'message' => 'Bibliotecarios obtenidos exitosamente.', 'data' => $personal];
