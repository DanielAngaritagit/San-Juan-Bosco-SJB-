...
try {
    // Asumiendo que el personal de aseo puede ser identificado por un rol o especialidad.
    ...
    $response = ['success' => true, 'message' => 'Personal de aseo obtenido exitosamente.', 'data' => $personal];
