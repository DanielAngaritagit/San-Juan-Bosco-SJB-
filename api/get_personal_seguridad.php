...
try {
    // Asumiendo que el personal de seguridad puede ser identificado por un rol o especialidad.
    ...
    $response = ['success' => true, 'message' => 'Personal de seguridad obtenido exitosamente.', 'data' => $personal];
