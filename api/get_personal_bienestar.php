...
try {
    // Asumiendo que el personal de bienestar puede ser parte de los profesores
    // o tener una especialidad que los identifique.
    ...
    $response = ['success' => true, 'message' => 'Personal de bienestar obtenido exitosamente.', 'data' => $personal];
