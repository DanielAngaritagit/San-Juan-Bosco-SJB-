...
<head>
    ...
    <link rel="stylesheet" href="../style/cal_padre.css?v=<?php echo time(); ?>">
</head>
<body>
    <div class="top-bar">
        ...
        <div class="project-info">
            ...
            <span class="module-name">Calendario - Padre</span>
        </div>
    </div>

    <div class="menu-container" id="menu-container">
        <div class="profile">
            <img src="../multimedia/pagina_principal/usuario.png" alt="Usuario" id="profile-img">
